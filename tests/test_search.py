...
search_test_ids = ["TK_01", "TK_02", "TK_03", "TK_04", "TK_05", "TK_06", "TK_07", "TK_08", "TK_09", "TK_10"]
...
@pytest.mark.parametrize( "test_id", search_test_ids, ids=search_test_ids)
def test_search_function(page, base_url, test_id):
    ...
    allure.dynamic.parameter("test_id",test_id,mode=allure.parameter_mode.HIDDEN)
