...
# # Kiểm tra message hiển thị trên trang.
# # Nếu expected_message có nhiều dòng thì kiểm tra từng dòng để tránh lỗi do xuống dòng/khoảng trắng.
...
# invalid_register_case_map = {
#     case["testId"]: case for case in invalid_register_cases
# }
